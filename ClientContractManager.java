...
public class ClientContractManager extends JPanel implements ActionListener{
	...
	public ClientContractManager(AccountManagement jframe){
		
		this.jframe = jframe;
		JLabel title = new JLabel("Client Contract Manager:           ");
	...
	public void saveDetails(){
		...
		Database.insertTableClientManager(referenceId,
				nameText.getText(), 
